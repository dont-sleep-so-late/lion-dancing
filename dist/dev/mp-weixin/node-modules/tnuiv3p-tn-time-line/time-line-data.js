  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        g: common_vendor.n(common_vendor.unref(ns).is("line", common_vendor.unref(showLine))),
        h: common_vendor.o(clickHandle)
      };
    };
  }
});
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/DIO/Desktop/大学/项目/狮业有成/demo-vue3/node_modules/tnuiv3p-tn-time-line/time-line-data.vue"]]);
